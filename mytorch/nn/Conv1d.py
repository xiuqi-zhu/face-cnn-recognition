...
class Conv1d_stride1():
    ...
    def backward(self, dLdZ):
        ...
        for i in range(dLdA.shape[-1]):
            dLdA[:,:,i]=np.tensordot(pad_dLdZ[:,:,i:i+self.kernel_size],flip_W,axes=([1,2],[0,2]))
...
class Conv1d():
    ...
    def forward(self, A):
        ...
        # Call Conv1d_stride1
        # TODO
        A_strid=self.conv1d_stride1.forward(A)

        # downsample
        Z = self.downsample1d.forward(A_strid)  # TODO
